...
export function DashboardNav({ userEmail }: { userEmail: string }) {
  ...
  return (
    <header className="border-b border-border">
      <div className="w-full px-4 sm:px-6 h-12 sm:h-14 flex items-center justify-between gap-4">
        <Link
          href="/dashboard"
        ...
        <div className="flex items-center gap-3">
          {/* Sync Playlists is always accessible in the nav regardless of sidebar state */}
          <SyncButton />
